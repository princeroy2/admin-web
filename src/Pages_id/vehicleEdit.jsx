...
//       // type: 'Point', // Assuming you want to keep this as a Point type
//     }
//     // latitude:0,
//     // longitude:0, 
//   });
...
//     form.append('currentLocation', JSON.stringify({
//       type: 'Point',
//       coordinates: [formData.currentLocation.coordinates[0], formData.currentLocation.coordinates[1]], // Assuming you want to send the coordinates as an array
//     }));
...
export default function Vedit() {
    ...
    if (type === 'file') {
      ...
      setFormData({
        ...
        currentLocation: {
          ...
          coordinates: [parseFloat(value), formData.currentLocation.coordinates[1]]
        }
      });
      ...
      setFormData({
        ...
        currentLocation: {
          ...formData.currentLocation,
          coordinates: [formData.currentLocation.coordinates[0], parseFloat(value)]
        }
      });
    } else if (type === 'number') {
      setFormData({ ...formData, [name]: parseFloat(value) });
  ...
  const handleUpdateVehicle = async (e) => {
    ...
    form.append('currentLocation', JSON.stringify({
      type: 'Point',
      coordinates: [formData.currentLocation.coordinates[0], formData.currentLocation.coordinates[1]],
    }));
