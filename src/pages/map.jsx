...
export default function Maps() {
  ...
  useEffect(() => {
    ...
    const fetchBookingData = async () => {
      try {
        const res = await fetch(`http://192.168.1.5:1234/booking/details/${id}`);
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
              {vehicles && (
                <div className="bg-white p-4 rounded shadow">
                  <img
                    src={vehicles.image ? `http://192.168.1.5:1234/uploads/${vehicles.image}` : 'https://via.placeholder.com/150'}
                    alt="Vehicle"
              ...
              <div className="mt-10">
                ...
                <div className="h-[300px] w-full rounded overflow-hidden shadow border border-gray-200">
                  <MapContainer center={route[0]} zoom={13} scrollWheelZoom={false} className="h-full w-full">
                    ...
                    icon={L.icon({
                        iconUrl: `http://192.168.1.5:1234/uploads/${vehicles.image}`,
